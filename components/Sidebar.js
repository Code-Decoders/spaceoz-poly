...
const Sidebar = () => {
  ...
  return (
    <div style={{ flex: 0.18 }} className={styles['sidebar-container']}>
      ...
      <div style={{ display: "flex", flexDirection: "column", width: "100%", flex: 1, alignItems: "flex-end", gap: "1.5rem 0" }}>
        <Link href={'/'}>
          <div className={styles['sidebar-button'] + (active == 0 ? ` ${styles['active']}` : "")}>
        ...
        <Link href={'playground'}>
          <div className={styles['sidebar-button'] + (active == 2 ? ` ${styles['active']}` : "")}>
